Return-Path: <ceph-devel+bounces-4527-lists+ceph-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+ceph-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OJsTBTC6b2kOMQAAu9opvQ
	(envelope-from <ceph-devel+bounces-4527-lists+ceph-devel=lfdr.de@vger.kernel.org>)
	for <lists+ceph-devel@lfdr.de>; Tue, 20 Jan 2026 18:24:00 +0100
X-Original-To: lists+ceph-devel@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [IPv6:2605:f480:58:1:0:1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id 96E1E487E7
	for <lists+ceph-devel@lfdr.de>; Tue, 20 Jan 2026 18:23:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 6E49750A8E2
	for <lists+ceph-devel@lfdr.de>; Tue, 20 Jan 2026 14:45:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3B1AD429806;
...
X-Spamd-Result: default: False [-0.46 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-4527-lists,ceph-devel=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[jlayton@kernel.org,ceph-devel@vger.kernel.org];
	FORGED_RECIPIENTS_MAILLIST(0.00)[];
	RCPT_COUNT_GT_50(0.00)[77];
	TAGGED_RCPT(0.00)[ceph-devel];
	MID_RHS_MATCH_FROM(0.00)[];
	ASN(0.00)[asn:7979, ipnet:2605:f480::/32, country:US];
	RCVD_VIA_SMTP_AUTH(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[dfw.mirrors.kernel.org:rdns,dfw.mirrors.kernel.org:helo]
X-Rspamd-Queue-Id: 96E1E487E7
