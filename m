...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id AC00F127D72
	for <lists+ceph-devel@lfdr.de>; Fri, 20 Dec 2019 15:37:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727632AbfLTOeV (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Fri, 20 Dec 2019 09:34:21 -0500
Received: from us-smtp-delivery-1.mimecast.com ([207.211.31.120]:43179 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1727451AbfLTOeU (ORCPT
        <rfc822;ceph-devel@vger.kernel.org>); Fri, 20 Dec 2019 09:34:20 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1576852459;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding;
        bh=jVhHE7z8NW8Sw3XNkw770c4rxD94EQTSzSivcx86Lac=;
        b=J02rTLXgkgQ8DYDMf8HG33hBdjGp1P2C2P0ZqeOiITnmiOC5SLZc7qb5a+/zrHzTHAkBns
        mlTvhoweyZUFoHbg6bV7iafgpCW4tQ/KuZrGRtkxRL0qrmGyJZIuOLpJnwEt3MWxEir7lT
        ANJMq2if6IWzVhMIDbpS/JwOrxOY/5U=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-259-FVV9CAD0PPmFjN17t60rUw-1; Fri, 20 Dec 2019 09:34:16 -0500
X-MC-Unique: FVV9CAD0PPmFjN17t60rUw-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.11])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id C6FBB802B9B;
        Fri, 20 Dec 2019 14:34:14 +0000 (UTC)
Received: from localhost.localdomain (ovpn-12-19.pek2.redhat.com [10.72.12.19])
        by smtp.corp.redhat.com (Postfix) with ESMTP id BBD9860576;
        Fri, 20 Dec 2019 14:34:09 +0000 (UTC)
From:   xiubli@redhat.com
To:     jlayton@kernel.org, idryomov@gmail.com
Cc:     sage@redhat.com, zyan@redhat.com, pdonnell@redhat.com,
        ceph-devel@vger.kernel.org, Xiubo Li <xiubli@redhat.com>
Subject: [PATCH v4] ceph: remove the extra slashes in the server path
Date:   Fri, 20 Dec 2019 09:34:04 -0500
Message-Id: <20191220143404.1425-1-xiubli@redhat.com>
MIME-Version: 1.0
...
@@ -459,6 +460,73 @@ static int strcmp_null(const char *s1, const char *s=
2)
 	return strcmp(s1, s2);
 }
=20
...
@@ -466,6 +534,7 @@ static int compare_mount_options(struct ceph_mount_op=
tions *new_fsopt,
...
@@ -478,9 +547,21 @@ static int compare_mount_options(struct ceph_mount_o=
ptions *new_fsopt,
...
@@ -866,9 +946,6 @@ static struct dentry *open_root_dentry(struct ceph_fs=
_client *fsc,
 	return root;
 }
=20
...
-
  ...
  */
@@ -883,7 +960,7 @@ static struct dentry *ceph_real_mount(struct ceph_fs_=
client *fsc,
...
+		const char *path, *p;
 		...
 		if (err < 0)
 			goto out;
@@ -895,17 +972,22 @@ static struct dentry *ceph_real_mount(struct ceph_f=
s_client *fsc,
 				goto out;
 		}
=20
