...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0D5EF12226
	for <lists+ceph-devel@lfdr.de>; Thu,  2 May 2019 20:46:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726360AbfEBSqn (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Thu, 2 May 2019 14:46:43 -0400
Received: from mail.kernel.org ([198.145.29.99]:55296 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726145AbfEBSqm (ORCPT <rfc822;ceph-devel@vger.kernel.org>);
        Thu, 2 May 2019 14:46:42 -0400
Received: from tleilax.poochiereds.net (cpe-71-70-156-158.nc.res.rr.com [71.70.156.158])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 8E52A2075E;
        Thu,  2 May 2019 18:46:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1556822801;
        bh=ncAilLBsWm7PwFe3PffgHv7ZyGFILYR3oiZbufVyUDI=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=L3kC93XJipxj1WMmlAfns2d811LCt88sgYNr2iuh5JnufLcCiYwUvOe4G/7jW+xId
         ESbYusvSWd6Q2GgekG+c08fzkIXdVqlE9h6g6glawkLo+uaaUO10ssdjcgmKHmXPwx
         bPbSwKbmm+pikK0c6xNTiPl+G7mElaOakeldKPTM=
From:   Jeff Layton <jlayton@kernel.org>
To:     zyan@redhat.com, sage@redhat.com, idryomov@gmail.com
Cc:     ceph-devel@vger.kernel.org
Subject: [PATCH v2 2/3] libceph: make ceph_pr_addr take an struct ceph_entity_addr pointer
Date:   Thu,  2 May 2019 14:46:37 -0400
Message-Id: <20190502184638.3614-2-jlayton@kernel.org>
...
@@ -1900,7 +1900,7 @@ static int ceph_dns_resolve_name(const char *name, size_t namelen,
 	*ipend = end;
...
@@ -1983,7 +1983,7 @@ int ceph_parse_ips(const char *c, const char *end,
...
+		dout("parse_ips got %s\n", ceph_pr_addr(&addr[i]));
 		...
 		if (p == end)
 			break;
@@ -2025,9 +2025,9 @@ static int process_banner(struct ceph_connection *con)
...
+			ceph_pr_addr(&con->actual_peer_addr),
 		...
 		return -1;
@@ -2045,7 +2045,7 @@ static int process_banner(struct ceph_connection *con)
...
+		     ceph_pr_addr(&con->msgr->inst.addr));
 	...
 	return 0;
@@ -2096,7 +2096,7 @@ static int process_connect(struct ceph_connection *con)
...
@@ -2106,7 +2106,7 @@ static int process_connect(struct ceph_connection *con)
...
@@ -2140,7 +2140,7 @@ static int process_connect(struct ceph_connection *con)
...
@@ -2197,7 +2197,7 @@ static int process_connect(struct ceph_connection *con)
...
+			       ceph_pr_addr(&con->peer_addr),
 			...
 			con->error_msg = "missing required protocol features";
 			reset_connection(con);
@@ -2404,7 +2404,7 @@ static int read_partial_message(struct ceph_connection *con)
...
+			ceph_pr_addr(&con->peer_addr),
 		...
 		con->in_base_pos = -front_len - middle_len - data_len -
 			sizeof_footer(con);
@@ -2983,10 +2983,10 @@ static void ceph_con_workfn(struct work_struct *work)
