...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0D0C22296B4
	for <lists+ceph-devel@lfdr.de>; Wed, 22 Jul 2020 12:56:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728345AbgGVKzV (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Wed, 22 Jul 2020 06:55:21 -0400
Received: from mail.kernel.org ([198.145.29.99]:53604 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728135AbgGVKzS (ORCPT <rfc822;ceph-devel@vger.kernel.org>);
        Wed, 22 Jul 2020 06:55:18 -0400
Received: from tleilax.com (68-20-15-154.lightspeed.rlghnc.sbcglobal.net [68.20.15.154])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id B9B2820771;
        Wed, 22 Jul 2020 10:55:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1595415318;
        bh=Qz1k29g/Ao+9Aq0gBDeuBYqtZdXfCssuNs5IDErbYsE=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=eKHKo3YZSXle27EMS2Q/DArshCBoaG8ILpF2gQxNtUUp9Utbi4WNFrp9C9qtVEpkm
         O1uEOkK1SEEQ/jYoPbTcSKMOmVfOMOjzJ6oIQwcxpNX++NJMKPeyqDGCUXHLSy8taj
         28qhWdBUBUxKxIOR7NhgkQfd8izMLD07/XsQQOzc=
From:   Jeff Layton <jlayton@kernel.org>
To:     ceph-devel@vger.kernel.org
Cc:     dhowells@redhat.com, dwysocha@redhat.com, smfrench@gmail.com
Subject: [RFC PATCH 07/11] ceph: convert readpage to fscache read helper
Date:   Wed, 22 Jul 2020 06:55:07 -0400
Message-Id: <20200722105511.11187-8-jlayton@kernel.org>
...
infrastructure. Have KConfig select FSCACHE_SUPPORT so that it will
still work even when FSCache proper is disabled.
...
index e955a38be3c8..734d08b57ef9 100644
--- a/fs/ceph/Kconfig
+++ b/fs/ceph/Kconfig
...
index 1dbc4adbfc72..98f5edbf70b6 100644
--- a/fs/ceph/addr.c
+++ b/fs/ceph/addr.c
@@ -12,6 +12,7 @@
