...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 2F2481796C3
	for <lists+ceph-devel@lfdr.de>; Wed,  4 Mar 2020 18:33:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729954AbgCDRdR (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Wed, 4 Mar 2020 12:33:17 -0500
Received: from us-smtp-delivery-1.mimecast.com ([207.211.31.120]:23166 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1729892AbgCDRdQ (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        bh=D/nRVWXUSGqoDLForis/gL+eZSFXDmdcmtN4aQQB1xY=;
        b=Sz0M7PFnJ0qg7+kwEU+t1h3GSSJ7XDGYN0cOKnAxblus4iEGkpZklXAdlEg+cEh3M1js28
        0YH80IiwZtPqzTPpcycH+gTWHylzC1fFx1Kz5/58+Yncrl/zK4PdRzujKZxIh+lAApgMOT
        3LgERM9360AkrzbiWcI1LXqN8eAWdAo=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-345-Mb3ylCvBN1CUY2RCqrz6zg-1; Wed, 04 Mar 2020 12:33:13 -0500
X-MC-Unique: Mb3ylCvBN1CUY2RCqrz6zg-1
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com [10.5.11.16])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 92F7D8034A6;
        Wed,  4 Mar 2020 17:33:12 +0000 (UTC)
Received: from zhyan-laptop.redhat.com (ovpn-12-198.pek2.redhat.com [10.72.12.198])
        by smtp.corp.redhat.com (Postfix) with ESMTP id E8D175C1D8;
        Wed,  4 Mar 2020 17:33:10 +0000 (UTC)
From:   "Yan, Zheng" <zyan@redhat.com>
To:     ceph-devel@vger.kernel.org
Cc:     jlayton@kernel.org, "Yan, Zheng" <zyan@redhat.com>
Subject: [PATCH v4 4/6] ceph: simplify calling of ceph_get_fmode()
Date:   Thu,  5 Mar 2020 01:32:56 +0800
Message-Id: <20200304173258.48377-5-zyan@redhat.com>
...
=20
 /*
@@ -3697,7 +3687,7 @@ static void handle_cap_export(struct inode *inode, =
...
@@ -3802,7 +3792,7 @@ static void handle_cap_import(struct ceph_mds_clien=
t *mdsc,
...
@@ -4155,16 +4145,6 @@ void ceph_get_fmode(struct ceph_inode_info *ci, in=
t fmode, int count)
