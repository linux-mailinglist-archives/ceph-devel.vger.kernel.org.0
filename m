...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DFE4E72B2C
	for <lists+ceph-devel@lfdr.de>; Wed, 24 Jul 2019 11:10:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726247AbfGXJK6 (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Wed, 24 Jul 2019 05:10:58 -0400
Received: from mx2.suse.de ([195.135.220.15]:58052 "EHLO mx1.suse.de"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726070AbfGXJK5 (ORCPT <rfc822;ceph-devel@vger.kernel.org>);
        Wed, 24 Jul 2019 05:10:57 -0400
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.220.254])
        by mx1.suse.de (Postfix) with ESMTP id CD824AEC8;
        Wed, 24 Jul 2019 09:10:55 +0000 (UTC)
...
References: <CAKOnarkzDoo3bWVGuDa7156Qziu9rP0gXKYeYPg_kZQGC_3x0A@mail.gmail.com>
 ...
 <CAKOnarmOeD0GDQTi4dnmU+tZjVDSp37aGXUx_FV1bb_3ga09Mg@mail.gmail.com>
 <CAKOnarmkm-dX+Fp+7R9sgQzupn1kLwL77FT8SdXh6qGB5+dpKw@mail.gmail.com>
From:   Igor Fedotov <ifedotov@suse.de>
Message-ID: <e79f81ad-da21-7941-da35-a5b105f2464f@suse.de>
Date:   Wed, 24 Jul 2019 12:10:39 +0300
...
Luminous vstart uses FileStore by default IIRC. Probably that's the case 
why it's working fine.

You can use -b switch to try it against bluestore.

The obvious difference for bluestore main device is that it is at least 
1GB smaller due to space allocated for bluefs (1GB minimum).


Also you can check bluefs volumes usage/free space using 
bluefs-bdev-sizes command from ceph-bluestore-tool.
...
On 7/24/2019 10:14 AM, Matt Benjamin wrote:
