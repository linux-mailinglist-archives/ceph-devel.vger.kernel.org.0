...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D9EEF6A3987
	for <lists+ceph-devel@lfdr.de>; Mon, 27 Feb 2023 04:29:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229729AbjB0D35 (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Sun, 26 Feb 2023 22:29:57 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36948 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229994AbjB0D34 (ORCPT
        <rfc822;ceph-devel@vger.kernel.org>); Sun, 26 Feb 2023 22:29:56 -0500
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 020CBE382
        for <ceph-devel@vger.kernel.org>; Sun, 26 Feb 2023 19:29:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1677468547;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=50Cj17nLRoO1bMLXs+WtaLcEJ/QaWS+dcdmqEYL1uBM=;
        b=W2OcdGk21SliO3Pk9PWX6tGdh/ILFADBEGkiGXVAQ8+L6u7rwILuxApzh+LKgpurREfc7A
        tqYYQWdxoVl3J5b64N2l61shzKmJPEJDZxqmcFpoWtVGIP4KnhHi0BDiAZSl9ctdopKnU/
        Ke78rBMeQWKvPLiSbegWmTLoaki3pJQ=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-260-6D9Pvd3cOfmGSb1pKQUJHQ-1; Sun, 26 Feb 2023 22:29:04 -0500
X-MC-Unique: 6D9Pvd3cOfmGSb1pKQUJHQ-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.rdu2.redhat.com [10.11.54.5])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 58D32811E9C;
        Mon, 27 Feb 2023 03:29:04 +0000 (UTC)
Received: from lxbceph1.gsslab.pek2.redhat.com (unknown [10.72.47.117])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 51FDD1731B;
        Mon, 27 Feb 2023 03:29:01 +0000 (UTC)
From:   xiubli@redhat.com
To:     idryomov@gmail.com, ceph-devel@vger.kernel.org
Cc:     jlayton@kernel.org, lhenriques@suse.de, vshankar@redhat.com,
        mchangir@redhat.com, Xiubo Li <xiubli@redhat.com>
Subject: [PATCH v16 12/68] ceph: fscrypt_auth handling for ceph
Date:   Mon, 27 Feb 2023 11:27:17 +0800
Message-Id: <20230227032813.337906-13-xiubli@redhat.com>
...
index c7e8dd5b58d4..8417e99b5677 100644
--- a/fs/ceph/acl.c
+++ b/fs/ceph/acl.c
@@ -140,7 +140,7 @@ int ceph_set_acl(struct user_namespace *mnt_userns, struct dentry *dentry,
...
@@ -151,7 +151,7 @@ int ceph_set_acl(struct user_namespace *mnt_userns, struct dentry *dentry,
...
index fec020ea459d..cbdb65c530f0 100644
--- a/fs/ceph/inode.c
+++ b/fs/ceph/inode.c
@@ -14,10 +14,12 @@
...
index 5b93b1ee5d8a..425ab3de22f6 100644
--- a/fs/ceph/super.h
+++ b/fs/ceph/super.h
