...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6F99E51224A
	for <lists+ceph-devel@lfdr.de>; Wed, 27 Apr 2022 21:16:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233557AbiD0TTj (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Wed, 27 Apr 2022 15:19:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42098 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232986AbiD0TTN (ORCPT
        <rfc822;ceph-devel@vger.kernel.org>); Wed, 27 Apr 2022 15:19:13 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5EB582E9E1
        for <ceph-devel@vger.kernel.org>; Wed, 27 Apr 2022 12:13:28 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id C5065B8291D
        for <ceph-devel@vger.kernel.org>; Wed, 27 Apr 2022 19:13:26 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 2B23DC385A7;
        Wed, 27 Apr 2022 19:13:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1651086805;
        bh=8Ia0W97r0E/fXoSo5DkApuQToRY2htx1BveUwf6gfCQ=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
From:   Jeff Layton <jlayton@kernel.org>
To:     ceph-devel@vger.kernel.org
Cc:     xiubli@redhat.com, lhenriques@suse.de, idryomov@gmail.com
Subject: [PATCH v14 12/64] ceph: fscrypt_auth handling for ceph
Date:   Wed, 27 Apr 2022 15:12:22 -0400
Message-Id: <20220427191314.222867-13-jlayton@kernel.org>
...
index 605662a33f34..74e428b22683 100644
--- a/fs/ceph/inode.c
+++ b/fs/ceph/inode.c
@@ -14,10 +14,12 @@
...
@@ -2280,6 +2337,7 @@ int __ceph_setattr(struct inode *inode, struct iattr *attr)
...
@@ -2320,7 +2378,7 @@ int ceph_setattr(struct user_namespace *mnt_userns, struct dentry *dentry,
...
index abf85813102c..38de82c2cb5a 100644
...
index b03cd54006db..0393087f70d8 100644
--- a/fs/ceph/super.c
+++ b/fs/ceph/super.c
@@ -20,6 +20,7 @@
 #include "super.h"
...
+#include "crypto.h"
 ...
 #include <linux/ceph/ceph_features.h>
 #include <linux/ceph/decode.h>
@@ -1130,6 +1131,8 @@ static int ceph_set_super(struct super_block *s, struct fs_context *fc)
...
index 595b72bf1f06..3d95e6fbbb85 100644
--- a/fs/ceph/super.h
+++ b/fs/ceph/super.h
...
@@ -1039,7 +1046,12 @@ static inline int ceph_do_getattr(struct inode *inode, int mask, bool force)
 }
