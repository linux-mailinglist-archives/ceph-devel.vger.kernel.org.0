...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A6C091796C2
	for <lists+ceph-devel@lfdr.de>; Wed,  4 Mar 2020 18:33:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729849AbgCDRdN (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Wed, 4 Mar 2020 12:33:13 -0500
Received: from us-smtp-1.mimecast.com ([207.211.31.81]:39386 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1729056AbgCDRdM (ORCPT
        <rfc822;ceph-devel@vger.kernel.org>); Wed, 4 Mar 2020 12:33:12 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1583343190;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=SkJY863itjb4BDOB5v04qAt/6qWj0H351tOfNePMTQ8=;
        b=CIqwRNgFxcfajFB4WfSGFmMjX23hLiqxT1ZNWgrJa14X9GCjwiBJy27n6vshWlTnzZ9NCq
        wI4cVOEzmH7cGYF/8Boa5DOmkZdGQKRv/5UY345NKlfMt03YO701vqmJ0uQWPSu+CWejEw
        xelUQfCTwuDf/xVK0pySHwHbkpfvobo=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-367-SNTRs1UNMCWc23DLn5c2Ng-1; Wed, 04 Mar 2020 12:33:08 -0500
X-MC-Unique: SNTRs1UNMCWc23DLn5c2Ng-1
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com [10.5.11.16])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id E1E17802C94;
        Wed,  4 Mar 2020 17:33:07 +0000 (UTC)
Received: from zhyan-laptop.redhat.com (ovpn-12-198.pek2.redhat.com [10.72.12.198])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 0B7EC5C1D4;
        Wed,  4 Mar 2020 17:33:05 +0000 (UTC)
From:   "Yan, Zheng" <zyan@redhat.com>
To:     ceph-devel@vger.kernel.org
Cc:     jlayton@kernel.org, "Yan, Zheng" <zyan@redhat.com>
Subject: [PATCH v4 2/6] ceph: consider inode's last read/write when calculating wanted caps
Date:   Thu,  5 Mar 2020 01:32:54 +0800
Message-Id: <20200304173258.48377-3-zyan@redhat.com>
...
@@ -1032,14 +1068,6 @@ int __ceph_caps_mds_wanted(struct ceph_inode_info =
*ci, bool check)
 	return mds_wanted;
 }
=20
...
@@ -1877,10 +1905,6 @@ void ceph_check_caps(struct ceph_inode_info *ci, i=
nt flags,
...
@@ -2105,9 +2129,17 @@ void ceph_check_caps(struct ceph_inode_info *ci, i=
nt flags,
...
=20
@@ -2573,8 +2605,9 @@ void ceph_take_cap_refs(struct ceph_inode_info *ci,=
 int got,
...
@@ -2584,7 +2617,6 @@ static int try_get_cap_refs(struct inode *inode, in=
t need, int want,
...
@@ -2600,15 +2632,6 @@ static int try_get_cap_refs(struct inode *inode, i=
nt need, int want,
 		goto out_unlock;
 	}
=20
...
-
 	...
 	while (ci->i_truncate_pending) {
 		spin_unlock(&ci->i_ceph_lock);
@@ -2719,6 +2742,9 @@ static int try_get_cap_refs(struct inode *inode, in=
t need, int want,
...
@@ -2756,10 +2782,20 @@ static void check_max_size(struct inode *inode, l=
off_t endoff)
...
@@ -2771,8 +2807,11 @@ int ceph_try_get_caps(struct inode *inode, int nee=
d, int want,
 			return ret;
 	}
=20
...
=20
@@ -2798,11 +2837,15 @@ int ceph_get_caps(struct file *filp, int need, in=
t want,
...
+			flags |=3D CHECK_FILELOCK;
 		...
 		ret =3D try_get_cap_refs(inode, need, want, endoff,
 				       flags, &_got);
@@ -2822,6 +2865,8 @@ int ceph_get_caps(struct file *filp, int need, int =
want,
...
=20
 			flags |=3D NON_BLOCKING;
@@ -2835,6 +2880,7 @@ int ceph_get_caps(struct file *filp, int need, int =
want,
 			}
=20
...
=20
 			...
 			list_del(&cw.list);
@@ -2854,7 +2900,7 @@ int ceph_get_caps(struct file *filp, int need, int =
want,
 		if (ret < 0) {
 			if (ret =3D=3D -ESTALE) {
...
@@ -4153,6 +4199,33 @@ void ceph_flush_dirty_caps(struct ceph_mds_client =
*mdsc)
...
+
 ...
 {
 	int i;
@@ -4168,26 +4241,18 @@ void __ceph_get_fmode(struct ceph_inode_info *ci,=
 int fmode)
