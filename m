...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 60190144529
	for <lists+ceph-devel@lfdr.de>; Tue, 21 Jan 2020 20:29:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729080AbgAUT3j (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Tue, 21 Jan 2020 14:29:39 -0500
Received: from mail.kernel.org ([198.145.29.99]:40236 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729061AbgAUT3i (ORCPT <rfc822;ceph-devel@vger.kernel.org>);
        Tue, 21 Jan 2020 14:29:38 -0500
Received: from tleilax.com (68-20-15-154.lightspeed.rlghnc.sbcglobal.net [68.20.15.154])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 330F22467C;
        Tue, 21 Jan 2020 19:29:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1579634977;
        bh=y3CM01mG9Ak38lsondLj8u5T5rHH2STlEUFe7XVhhY4=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=J22hXQreiNTouixehhtIfQ8gAirC73FBIWkX/GNKXhrwmhQkifAL3OY4hmTmfeNTz
         goeCcHv4IA//0m50TDNPs8y3XTHAyRMubgIt4dElV4RNS7/Ge+Ai4e1i9NNw684bZE
         92opr7/LA1EUs72pKPOUYrtYCRldwfKRE3Iq9svI=
From:   Jeff Layton <jlayton@kernel.org>
To:     ceph-devel@vger.kernel.org
Cc:     idridryomov@gmail.com, sage@redhat.com, zyan@redhat.com
Subject: [RFC PATCH v3 10/10] ceph: attempt to do async create when possible
Date:   Tue, 21 Jan 2020 14:29:28 -0500
Message-Id: <20200121192928.469316-11-jlayton@kernel.org>
...
index b44ccbc85fe4..170bbb18f33e 100644
--- a/fs/ceph/file.c
+++ b/fs/ceph/file.c
@@ -448,6 +448,190 @@ cache_file_layout(struct inode *dst, struct inode *src)
...
+		pr_warn("%s: async create failure result=%d!\n", __func__, result);
+	}
+
...
@@ -460,6 +644,7 @@ int ceph_atomic_open(struct inode *dir, struct dentry *dentry,
 	struct ceph_mds_request *req;
 	struct dentry *dn;
 	struct ceph_acl_sec_ctx as_ctx = {};
...
@@ -492,28 +677,42 @@ int ceph_atomic_open(struct inode *dir, struct dentry *dentry,
 	}
...
@@ -527,7 +726,7 @@ int ceph_atomic_open(struct inode *dir, struct dentry *dentry,
 		dn = NULL;
 	}
 	if (err)
-		goto out_req;
...
@@ -543,9 +742,10 @@ int ceph_atomic_open(struct inode *dir, struct dentry *dentry,
 		}
