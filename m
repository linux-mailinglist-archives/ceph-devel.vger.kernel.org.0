...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A37731736AF
	for <lists+ceph-devel@lfdr.de>; Fri, 28 Feb 2020 12:57:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726871AbgB1L4J (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Fri, 28 Feb 2020 06:56:09 -0500
Received: from us-smtp-delivery-1.mimecast.com ([207.211.31.120]:35329 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726418AbgB1L4J (ORCPT
        <rfc822;ceph-devel@vger.kernel.org>); Fri, 28 Feb 2020 06:56:09 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1582890967;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=HsePLLrptL0a0ByuYSQ/pRMsM/GM9k4WlT83CGtWm/Y=;
        b=gLBJpTrTCKwRuoVR3dyd56/jeQ0o2KNGBvPswlKlTJlHCXJU2TZx8lGWxVNIsrGWkTrAZ/
        df2HavAa+gVR+TDIqSNaBM1wHAUcMrI70bKazs6tMmND7rveUnjwZUh3uj6zdMkS9z/SPz
        amUgruJOE5EZOOcWJDY9rWdwHU067VY=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-439-g2N2o404NnGaL7i2_ONwXg-1; Fri, 28 Feb 2020 06:56:05 -0500
X-MC-Unique: g2N2o404NnGaL7i2_ONwXg-1
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com [10.5.11.16])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 913E218FF660;
        Fri, 28 Feb 2020 11:56:02 +0000 (UTC)
Received: from zhyan-laptop.redhat.com (ovpn-12-212.pek2.redhat.com [10.72.12.212])
        by smtp.corp.redhat.com (Postfix) with ESMTP id B65C15C54A;
        Fri, 28 Feb 2020 11:56:00 +0000 (UTC)
From:   "Yan, Zheng" <zyan@redhat.com>
To:     ceph-devel@vger.kernel.org
Cc:     jlayton@kernel.org, "Yan, Zheng" <zyan@redhat.com>
Subject: [PATCH v3 3/6] ceph: simplify calling of ceph_get_fmode()
Date:   Fri, 28 Feb 2020 19:55:47 +0800
Message-Id: <20200228115550.6904-4-zyan@redhat.com>
...
index 1bd91ca8aeb4..ccee4a0814d7 100644
--- a/fs/ceph/caps.c
+++ b/fs/ceph/caps.c
...
=20
 /*
@@ -3732,7 +3722,7 @@ static void handle_cap_export(struct inode *inode, =
...
@@ -3837,7 +3827,7 @@ static void handle_cap_import(struct ceph_mds_clien=
t *mdsc,
...
@@ -4189,16 +4179,6 @@ void ceph_get_fmode(struct ceph_inode_info *ci, in=
t fmode, int count)
...
index 786b72e7696f..88da7f68e513 100644
--- a/fs/ceph/file.c
+++ b/fs/ceph/file.c
