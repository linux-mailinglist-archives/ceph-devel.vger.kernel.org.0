...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B6F3D51226D
	for <lists+ceph-devel@lfdr.de>; Wed, 27 Apr 2022 21:17:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234177AbiD0TUw (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Wed, 27 Apr 2022 15:20:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55472 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233375AbiD0TTi (ORCPT
        <rfc822;ceph-devel@vger.kernel.org>); Wed, 27 Apr 2022 15:19:38 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 927EE562E1
        for <ceph-devel@vger.kernel.org>; Wed, 27 Apr 2022 12:13:57 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 37644B82929
        for <ceph-devel@vger.kernel.org>; Wed, 27 Apr 2022 19:13:56 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 74659C385A7;
        Wed, 27 Apr 2022 19:13:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1651086834;
        bh=9sOqgb2cONNW6hUHEIc2S+PiLV8mtademKpkGP4Uq54=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
From:   Jeff Layton <jlayton@kernel.org>
To:     ceph-devel@vger.kernel.org
Cc:     xiubli@redhat.com, lhenriques@suse.de, idryomov@gmail.com
Subject: [PATCH v14 54/64] ceph: add read/modify/write to ceph_sync_write
Date:   Wed, 27 Apr 2022 15:13:04 -0400
Message-Id: <20220427191314.222867-55-jlayton@kernel.org>
...
index 596f133b63ec..472c525f732d 100644
--- a/fs/ceph/file.c
+++ b/fs/ceph/file.c
@@ -1550,18 +1550,16 @@ ceph_sync_write(struct kiocb *iocb, struct iov_iter *from, loff_t pos,
...
-	size_t off;
 	...
 	if (ceph_snap(file_inode(file)) != CEPH_NOSNAP)
 		return -EROFS;
@@ -1581,29 +1579,236 @@ ceph_sync_write(struct kiocb *iocb, struct iov_iter *from, loff_t pos,
 	if (ret < 0)
...
+			}
 		...
 		left = len;
@@ -1611,43 +1816,98 @@ ceph_sync_write(struct kiocb *iocb, struct iov_iter *from, loff_t pos,
...
+		dout("sync_write written %d\n", written);
 		if (pos > i_size_read(inode)) {
 			...
 			if (check_caps)
@@ -1662,6 +1922,7 @@ ceph_sync_write(struct kiocb *iocb, struct iov_iter *from, loff_t pos,
 		ret = written;
 		iocb->ki_pos = pos;
 	}
