...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 23F3E51229D
	for <lists+ceph-devel@lfdr.de>; Wed, 27 Apr 2022 21:24:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233718AbiD0T2B (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Wed, 27 Apr 2022 15:28:01 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46398 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232955AbiD0TTN (ORCPT
        <rfc822;ceph-devel@vger.kernel.org>); Wed, 27 Apr 2022 15:19:13 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ED76D86AD5
        for <ceph-devel@vger.kernel.org>; Wed, 27 Apr 2022 12:13:25 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 7BB6E619D0
        for <ceph-devel@vger.kernel.org>; Wed, 27 Apr 2022 19:13:25 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 616C7C385AA;
        Wed, 27 Apr 2022 19:13:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1651086804;
        bh=kzPlbSGQkQUSFKQyICB2Ge35eRx9aG04HD8NlUgaki4=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
From:   Jeff Layton <jlayton@kernel.org>
To:     ceph-devel@vger.kernel.org
Cc:     xiubli@redhat.com, lhenriques@suse.de, idryomov@gmail.com
Subject: [PATCH v14 11/64] ceph: preallocate inode for ops that may create one
Date:   Wed, 27 Apr 2022 15:12:21 -0400
Message-Id: <20220427191314.222867-12-jlayton@kernel.org>
...
index c805a5f5a6d1..391de38fa489 100644
--- a/fs/ceph/file.c
+++ b/fs/ceph/file.c
...
@@ -727,6 +722,7 @@ int ceph_atomic_open(struct inode *dir, struct dentry *dentry,
...
@@ -739,16 +735,16 @@ int ceph_atomic_open(struct inode *dir, struct dentry *dentry,
...
@@ -757,7 +753,7 @@ int ceph_atomic_open(struct inode *dir, struct dentry *dentry,
...
+
 	...
 	if (IS_ERR(req)) {
@@ -778,25 +774,40 @@ int ceph_atomic_open(struct inode *dir, struct dentry *dentry,
...
+				new_inode = NULL;
 				...
 				goto retry;
@@ -807,6 +818,8 @@ int ceph_atomic_open(struct inode *dir, struct dentry *dentry,
 	}
...
+	new_inode = NULL;
 	err = ceph_mdsc_do_request(mdsc,
 				   ...
 				   req);
@@ -849,6 +862,7 @@ int ceph_atomic_open(struct inode *dir, struct dentry *dentry,
 	}
 out_req:
 	ceph_mdsc_put_request(req);
+	iput(new_inode);
...
index d05b91391f17..605662a33f34 100644
--- a/fs/ceph/inode.c
+++ b/fs/ceph/inode.c
...
index 46a13ea9d284..abf85813102c 100644
...
index 0c7a6fedc58a..595b72bf1f06 100644
--- a/fs/ceph/super.h
+++ b/fs/ceph/super.h
