...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B5F3549BE17
	for <lists+ceph-devel@lfdr.de>; Tue, 25 Jan 2022 22:59:54 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233443AbiAYV7x (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Tue, 25 Jan 2022 16:59:53 -0500
Received: from us-smtp-delivery-124.mimecast.com ([170.10.129.124]:30420 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S233434AbiAYV7w (ORCPT
        <rfc822;ceph-devel@vger.kernel.org>);
        Tue, 25 Jan 2022 16:59:52 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1643147991;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=dB/iga8/kca9IjteG5d6q81LqSI85jgSZ+mX0iJ7/Eo=;
        b=S78MCfoB5nhHY+f/kTl6Z5KoEfTJqSTq5PQ3nmKVLEZVrV5avz6Itg9AE7tRmtlV8512GS
        QA6HkNDbqB6UHEClfHBep/qr+P7byZ841p1GC8+YAG0lBQUnaZ5KKDP9cFc3a9d7U5+wka
        Ae8jJwI1Uj7NpRjmfUb3UiYAH9Go5CE=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-91-47UlLFOaPhih47CbrO1hLA-1; Tue, 25 Jan 2022 16:59:46 -0500
X-MC-Unique: 47UlLFOaPhih47CbrO1hLA-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 7EF561083F60;
        Tue, 25 Jan 2022 21:59:44 +0000 (UTC)
Received: from horse.redhat.com (unknown [10.22.9.177])
        by smtp.corp.redhat.com (Postfix) with ESMTP id CFF6CE73A;
        Tue, 25 Jan 2022 21:59:43 +0000 (UTC)
Received: by horse.redhat.com (Postfix, from userid 10451)
        id 4D090223DA6; Tue, 25 Jan 2022 16:59:43 -0500 (EST)
Date:   Tue, 25 Jan 2022 16:59:43 -0500
...
Message-ID: <YfByz7Rxy0kJlQbC@redhat.com>
...
On Tue, Jan 25, 2022 at 09:08:59AM -0800, Casey Schaufler wrote:
...
If this is true that BPF LSM is stacked last, then there should not
be any need to eschew call_int_hook(). Just use.

LSM_HOOK(int, -EOPNOTSUPP, dentry_init_security, ....)

and that should fix the issue, atleast with current code. As only two
LSMs (SELinux and BPF) seem to register handler for this.

Having said that, open coding like security_inode_getsecurity() does
not rely on this assumption that BPF LSM is always stacked last.
