...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 972C0129D35
	for <lists+ceph-devel@lfdr.de>; Tue, 24 Dec 2019 05:05:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726928AbfLXEFg (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Mon, 23 Dec 2019 23:05:36 -0500
Received: from us-smtp-1.mimecast.com ([207.211.31.81]:26879 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726747AbfLXEFg (ORCPT
        <rfc822;ceph-devel@vger.kernel.org>);
        Mon, 23 Dec 2019 23:05:36 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1577160334;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=b0wkM2zcCzCbHnoSYwrbUTRypTa0sIEfxJyNAaQj8N4=;
        b=VRCGrQgCr1wG8HShf7N2LnGY2ivmBlKB1pxHxPksua0x86mP1O2nDtcgB4dsiLz9OjMiNn
        xTv7oUcb4mMUMVqoDYQ8C8z9Cfv9cMrVTH/8Rtjgrtv72VB/tTIrgms2+a2PG4w13FwOHo
        svnQfIFIzMD1ka3uYzq0T/a8aGDsZbk=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-81-7YSFNyZXPruFwNAV5PEEZA-1; Mon, 23 Dec 2019 23:05:32 -0500
X-MC-Unique: 7YSFNyZXPruFwNAV5PEEZA-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com [10.5.11.22])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 66831800D48;
        Tue, 24 Dec 2019 04:05:31 +0000 (UTC)
Received: from localhost.localdomain (ovpn-12-64.pek2.redhat.com [10.72.12.64])
        by smtp.corp.redhat.com (Postfix) with ESMTP id A8B351000322;
        Tue, 24 Dec 2019 04:05:28 +0000 (UTC)
From:   xiubli@redhat.com
To:     jlayton@kernel.org, idryomov@gmail.com
Cc:     sage@redhat.com, zyan@redhat.com, pdonnell@redhat.com,
        ceph-devel@vger.kernel.org, Xiubo Li <xiubli@redhat.com>
Subject: [PATCH 2/4] ceph: add caps perf metric for each session
Date:   Mon, 23 Dec 2019 23:05:12 -0500
Message-Id: <20191224040514.26144-3-xiubli@redhat.com>
...
index b1b4d1a9bd2f..f58b74b2d1ec 100644
--- a/fs/ceph/mds_client.c
+++ b/fs/ceph/mds_client.c
@@ -557,6 +557,8 @@ void ceph_put_mds_session(struct ceph_mds_session *s)
...
@@ -597,6 +599,7 @@ static struct ceph_mds_session *register_session(stru=
...
@@ -611,8 +614,10 @@ static struct ceph_mds_session *register_session(str=
...
@@ -652,6 +657,13 @@ static struct ceph_mds_session *register_session(str=
uct ceph_mds_client *mdsc,
=20
...
@@ -661,6 +673,8 @@ static struct ceph_mds_session *register_session(stru=
ct ceph_mds_client *mdsc,
=20
 	return s;
=20
...
index 55249f667a98..6b91f20132c0 100644
--- a/fs/ceph/mds_client.h
+++ b/fs/ceph/mds_client.h
@@ -192,6 +192,9 @@ struct ceph_mds_session {
 	refcount_t        s_ref;
