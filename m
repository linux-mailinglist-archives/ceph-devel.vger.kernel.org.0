...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 823611736AE
	for <lists+ceph-devel@lfdr.de>; Fri, 28 Feb 2020 12:57:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726806AbgB1L4H (ORCPT <rfc822;lists+ceph-devel@lfdr.de>);
        Fri, 28 Feb 2020 06:56:07 -0500
Received: from us-smtp-1.mimecast.com ([205.139.110.61]:60164 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726418AbgB1L4G (ORCPT
        <rfc822;ceph-devel@vger.kernel.org>);
        Fri, 28 Feb 2020 06:56:06 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1582890965;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=JfMM0W52zohRh5aLfdUGika1UieTeApXxPxMg6hsvwo=;
        b=B6qwyWI2eyGuJ681rjN7+64XhrPV4XQPkzSun0QjKaWwzIRTYZGlcC8tCVD6EB3fPUSbzq
        Vht4a8CBTsDgW7W5KwXMP0YXgo/Ys4pH+8HQAnn68Mbcz4rRTvE6Wxd8wzPe6H4wPPUg+F
        sMjEWKGfbwq316uVKjFaDri1H08uqFA=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-116-CTiJrAHIMtOne8SJ757jTg-1; Fri, 28 Feb 2020 06:56:01 -0500
X-MC-Unique: CTiJrAHIMtOne8SJ757jTg-1
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com [10.5.11.16])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 26D578017CC;
        Fri, 28 Feb 2020 11:56:00 +0000 (UTC)
Received: from zhyan-laptop.redhat.com (ovpn-12-212.pek2.redhat.com [10.72.12.212])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 2B76B5C54A;
        Fri, 28 Feb 2020 11:55:57 +0000 (UTC)
From:   "Yan, Zheng" <zyan@redhat.com>
To:     ceph-devel@vger.kernel.org
Cc:     jlayton@kernel.org, "Yan, Zheng" <zyan@redhat.com>
Subject: [PATCH v3 2/6] ceph: consider inode's last read/write when calculating wanted caps
Date:   Fri, 28 Feb 2020 19:55:46 +0800
Message-Id: <20200228115550.6904-3-zyan@redhat.com>
...
index 293920d013ff..1bd91ca8aeb4 100644
--- a/fs/ceph/caps.c
+++ b/fs/ceph/caps.c
@@ -971,18 +971,52 @@ int __ceph_caps_used(struct ceph_inode_info *ci)
 	return used;
 }
=20
...
+
 	if (bits =3D=3D 0)
 		return 0;
+	if (bits =3D=3D (1 << PIN_SHIFT) && !S_ISDIR(ci->vfs_inode.i_mode))
+		return 0;
+
 	return ceph_caps_for_mode(bits >> 1);
 }
=20
@@ -1021,14 +1055,6 @@ int __ceph_caps_mds_wanted(struct ceph_inode_info =
*ci, bool check)
 	return mds_wanted;
 }
=20
...
@@ -1856,10 +1882,6 @@ void ceph_check_caps(struct ceph_inode_info *ci, i=
nt flags,
...
@@ -2081,9 +2103,16 @@ void ceph_check_caps(struct ceph_inode_info *ci, i=
nt flags,
...
=20
@@ -2549,8 +2578,9 @@ static void __take_cap_refs(struct ceph_inode_info =
*ci, int got,
...
@@ -2560,7 +2590,6 @@ static int try_get_cap_refs(struct inode *inode, in=
t need, int want,
...
@@ -2576,15 +2605,6 @@ static int try_get_cap_refs(struct inode *inode, i=
nt need, int want,
 		goto out_unlock;
 	}
=20
...
-
 	...
 	while (ci->i_truncate_pending) {
 		spin_unlock(&ci->i_ceph_lock);
@@ -2692,6 +2712,9 @@ static int try_get_cap_refs(struct inode *inode, in=
t need, int want,
...
@@ -2729,10 +2752,20 @@ static void check_max_size(struct inode *inode, l=
off_t endoff)
...
SHARED));
@@ -2740,8 +2773,11 @@ int ceph_try_get_caps(struct inode *inode, int nee=
d, int want,
 	if (ret < 0)
 		return ret;
=20
...
=20
@@ -2767,11 +2803,15 @@ int ceph_get_caps(struct file *filp, int need, in=
t want,
...
+			flags |=3D CHECK_FILELOCK;
 		...
 		ret =3D try_get_cap_refs(inode, need, want, endoff,
 				       flags, &_got);
@@ -2791,6 +2831,8 @@ int ceph_get_caps(struct file *filp, int need, int =
want,
...
=20
 			flags |=3D NON_BLOCKING;
@@ -2804,6 +2846,7 @@ int ceph_get_caps(struct file *filp, int need, int =
want,
 			}
=20
...
=20
 			...
 			list_del(&cw.list);
@@ -2823,7 +2866,7 @@ int ceph_get_caps(struct file *filp, int need, int =
want,
 		if (ret < 0) {
 			if (ret =3D=3D -ESTALE) {
...
@@ -4121,6 +4164,31 @@ void ceph_flush_dirty_caps(struct ceph_mds_client =
*mdsc)
...
+
 ...
 {
 	int i;
@@ -4136,26 +4204,18 @@ void __ceph_get_fmode(struct ceph_inode_info *ci,=
 int fmode)
...
index 7db97304bf06..786b72e7696f 100644
--- a/fs/ceph/file.c
+++ b/fs/ceph/file.c
